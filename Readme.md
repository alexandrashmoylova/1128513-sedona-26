...
* Студент: [Александра Шмойлова](https://up.htmlacademy.ru/htmlcss/26/user/1128513).
* Наставник: [Александр Бекк](https://htmlacademy.ru/profile/id399961).
...
[Откройте мастер-репозиторий](https://github.com/htmlacademy-htmlcss/1128513-sedona-26) и нажмите кнопку «Fork» в правом верхнем углу. Репозиторий из Академии скопируется в ваш аккаунт.
